...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleUserAccountNotActivatedException(UserAccountNotActivatedException ex) {
        Map<String, Object> response = new HashMap<>();
        response.put("status", "error");
    ...
    public ResponseEntity<Map<String, Object>> handleInvalidActivationTokenException(InvalidActivationTokenException ex) {
        Map<String, Object> response = new HashMap<>();
        response.put("status", "error");
        response.put("message", ex.getMessage());
